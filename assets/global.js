...
class PincodeChecker extends HTMLElement {
  ...
  constructor() {
    super();
    this.pincodeJson = {};
    this.sheetKey = '1PCidkNcZM8-MKyHrZwYTkM4xyhoUlwLbpjTFTJeaL_I';
    this.apiKey = 'AIzaSyAWfC2q1xE4O0KWSud5AxhcO3Ymlee3CKw';
    ...
    this.sheetUrl = `https://sheets.googleapis.com/v4/spreadsheets/${this.sheetKey}/values/${this.sheetName}?key=${this.apiKey}`;

    this.getPincodeJson();

    this.pincodeSubmitBtn.addEventListener('click', ()=>{
